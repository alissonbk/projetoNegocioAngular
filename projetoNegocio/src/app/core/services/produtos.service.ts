...
export class ProdutosService extends AbstractService {
  ...
  cadastrarProduto(value: any) {
    return this.http.post(`${this.API_URL}/v1/produtos`, value, {headers: this.headers}).pipe(take(1));
  }

  editarProduto(value: any){
    return this.http.put(`${this.API_URL}/v1/produtos/`+ value.id, value, {headers: this.headers}).pipe();
  }

  excluirProduto(id: number){
    return this.http.delete(`${this.API_URL}/v1/produtos/`+ id, {headers: this.headers}).pipe();
  }
